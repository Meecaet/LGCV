using DAL_CV_Fiches.Models.Rapport;
using System;
using System.Collections.Generic;
using System.Text;

namespace DAL_CV_Fiches.Repositories.Rapport
{
    public class CVDepot
    {
        public CV GetOneCV()
        {
            CV rapportCV = new CV();
...
Curabitur suscipit nulla id orci sagittis laoreet.Nunc in risus dolor. Nullam eros purus, laoreet in elit sagittis, facilisis tristique est. Maecenas sollicitudin consectetur nisl, vitae feugiat ante egestas in. Suspendisse potenti. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.Donec ultricies lobortis sagittis. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas";
            ...
            rapportCV.DomaineDInterventions = new List<DomaineDIntervention> { new DomaineDIntervention { Id = 1, Description = "Programmation" }, new DomaineDIntervention { Id = 2, Description = "Analyse" }, new DomaineDIntervention { Id = 3, Description = "Architecture" } };
            rapportCV.FormationAcademiques = new List<FormationAcademique> { new FormationAcademique { Id = 1, Diplome = "Analyse de systèmes", AnDuTitre = 1999, Instituition = "Université de Laval" } };
            rapportCV.Certifications = new List<Certification> { new Certification { Id = 1, Description = "ITIL" } };
